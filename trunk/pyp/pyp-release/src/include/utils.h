...
public: 
  ...
  static int splitToStrMD(std::string buff,
  ...
  static int splitToIntMD(std::string buff, std::vector<int>& items, 
                           std::string delm = ",") {
    items.clear();
    std::vector<std::string> tmpVector(0);
    int i = 0;
    i = splitToStrMD(buff.c_str(), tmpVector, delm.c_str());
    if( i > 0 )
      for( int j = 0; j < i; j++ )
  ...
  static int splitToFloat(std::string buff, std::vector<float>& items, 
                           std::string delm = ",") {
    items.clear();
    std::vector<std::string> tmpVector(0);
    int i = 0;
