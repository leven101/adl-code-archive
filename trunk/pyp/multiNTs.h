...
const ParamDefs paramdefs[] = {
  ...
  {"src-nts", "/Users/ablev/work/data/fbis-mini/mkcls/zh.out", "swc", Parameters::kStringValue, ""},
  {"trg-nts", "/Users/ablev/work/data/fbis-mini/mkcls/en.out", "twc", Parameters::kStringValue, ""},
  ...
  {"block-sample", Parameters::kFalseValue, "bs", Parameters::kBoolValue, ""},
  {"bs-every", "8", "", Parameters::kIntValue, ""},
  {"discount", "0.8", "a", Parameters::kFloatValue, ""},
  {"strength", "1", "b", Parameters::kFloatValue, ""},
  {"poisson-mean", "1", "p", Parameters::kFloatValue, ""},
  {"terminal-penalty", ".55", "tp", Parameters::kFloatValue, ""},
  ...
  {"hierarchical", Parameters::kFalseValue, "hier", Parameters::kBoolValue, ""},
  {"restrict-scfg", Parameters::kTrueValue, "X", Parameters::kBoolValue, ""},
};
